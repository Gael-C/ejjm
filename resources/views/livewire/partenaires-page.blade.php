<section class="text-gray-600 body-font">
    <div class="container px-5 py-24 mx-auto flex flex-wrap">
        <div class="flex w-full mb-20 flex-wrap">
            <h1 class="sm:text-3xl text-2xl font-medium title-font text-gray-900 dark:text-white lg:w-1/3 lg:mb-0 mb-4">Nos partenaires</h1>
            <p class="lg:pl-6 lg:w-2/3 mx-auto leading-relaxed text-base dark:text-white">Comme un club sportif amateur n'est rien sans ces partenaires, voici nos mécènes qui nous aident cette saison.</p>
        </div>
